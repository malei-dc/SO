...
>	2.2 Si no hay un frame libre, usar un algoritmo de reemplazo de páginas para seleccionar un frame vı́ctima.
>	2.3 Escribir el contenido del frame vı́ctima a almacenamiento secundario (si hace falta) (en general, a espacio de swap); actualizar la tabla de páginas (y demás tablas).
